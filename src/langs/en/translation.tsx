const enTranslation = {
    ...
    "lightbringer_desc": "Lightbringer is one of Sweden’s hottest AI startups, revolutionizing the way companies innovate and protect their ideas. We combine cutting-edge technology with a deep understanding of the patent landscape to empower creators, engineers, and businesses worldwide. Our world-class team in Lund is growing, and we’re on the lookout for exceptional individuals who share our passion for reshaping the future of innovation. Whether you’re seeking a hands-on summer internship, a master’s thesis project that tackles real-world challenges, or a full-time position with global impact, Lightbringer has a place for you. Join us today and help shape tomorrow’s world, and far beyond.",
    "if_desc": "Are you interested in statistics and data analysis and want to use it in business decisions? Kickstart your career with us at If! As the largest insurance company in the Nordic region, we regularly analyze large amounts of data and trends to keep our pricing up to date. Another important job we do is using our data to detect potential fraud. We’re looking for new analysts who enjoy coding in Python and diving into data while making a difference in society and people’s lives. If that sounds exciting, feel free to stop by and chat with us at FARAD! \n\n Are you in your 3rd or 4th year? Check out our summer job as an analyst, and if you’re interested, there may also be opportunities for a thesis project. If you’re at the end of your studies, make sure to apply for our analyst trainee program :smiley: \n\n Link to the trainee program: https://if.wd3.myworkdayjobs.com/en-US/Careers/details/If-Trainee-Program-2025_JobReqID8835-1",
    "axis_desc": "Axis Communications is a Swedish company specializing in network solutions, particularly in video surveillance. Founded in 1984, Axis pioneered the development of the world’s first network camera in 1996, revolutionizing the security industry. We focus on innovative, high-quality products that combine advanced technology with sustainability, enabling businesses and public organizations to enhance safety and operational efficiency. \n\n We offer a broad portfolio of network cameras, video encoders, audio systems, and analytics software, catering to diverse industries such as retail, healthcare, transportation, and critical infrastructure. \n\n Headquartered in Lund, Sweden, we operate globally with a strong commitment to local partnerships and environmental responsibility. As a market leader, Axis continues to shape the future of smart security solutions, driving innovation. \n\n During our 40-year-old journey, we have worked closely with students, and we are excited to continue to do so. If you want to learn more about how it is to be a student at Axis. Come speak to us at FARAD and read more at: https://www.axis.com/careers/student-opportunities.",
    ...
    "sentianai_desc": "We specialize in delivering leading-edge Industrial AI solutions specifically tailored for the mining industry, representing a new era of process optimization. Our approach is marked by remarkable advancements in performance, sustainability, and efficiency. \n\n At our core, we leverage state-of-the-art AI to address the intricate challenges of process optimization within mining operations. Our expertise shines in managing complex, nonlinear interactions among numerous variables and trade-offs inherent to mining processes. \n\n Empowering mining operations is our primary focus , providing guidance and AI-assisted decision-making. \n\n Excitingly, we have recently become a part of The Weir Group PLC, a global leader in mining technology. This strategic acquisition aligns with our commitment to helping mining industries operate with the highest productivity and lowest environmental impact. \n\n Our Socials \n\n Website: https://sentian.ai \n\n LinkedIn: https://www.linkedin.com/company/15157579/admin/feed/posts/",
    "netcompany_desc": "Netcompany is a pure-play IT services company, delivering critical IT projects to both the private and public sector. By building agile, scalable, and secure digital solutions, Netcompany is positioned to drive Europe towards a sustainable future in a decade of digitalisation. Netcompany was founded in 2000 with headquarters in Copenhagen, Denmark. Today, we are an international company with more than 7700 employees from over 50 different nationalities, working from more than 10 countries. \n\n At Netcompany, we’re dedicated to creating innovative IT solutions that make a real difference. As part of our Operations department, you’ll play a key role in ensuring that businesses, public institutions and citizens can rely on seamless and secure digital services. From optimizing IT infrastructure to managing complex systems, you’ll help shape the backbone of tomorrow’s digital society. \n\n Joining Netcompany means becoming part of a team that values collaboration, continuous development and making a lasting impact. You’ll work in a dynamic environment where your ideas and skills are valued, and you’ll have the opportunity to grow professionally while solving exciting challenges. \n\n Come meet us at FARAD on January 30th, 2025 and let’s explore how you can kickstart your career with us.",
}
